...
## 1. WSL에서 PokeRogue 구동 (Front-end)
### 설치과정
...
## 5. Windows도 App으로 하고 싶다.
[Github : Pokerogue-App](https://github.com/Admiral-Billy/Pokerogue-App) 여기 repo를 가져와서 할 예정
...
# output would be in dist/platform-unpached/PokeRogue.exe
```